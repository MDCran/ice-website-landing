    ...
    <div className="w-full h-full relative">
      ...
      <div className="relative z-10 flex flex-col h-full px-12 py-9">
        <motion.div className="flex items-center gap-3 mb-5" {...fadeIn(active, 0.05, { x: -20 })}>
          ...
          <div><h2 className="text-2xl font-bold text-white">Proposed Platform Investment</h2><p className="text-slate-500 text-xs">Fully managed IBM i hosting, DR, backup, and operational support</p></div>
        </motion.div>

        <div className="flex-1 flex flex-col gap-3 justify-center">
          <motion.div className="rounded-xl border border-sky-400/20 bg-sky-400/[0.04] px-6 py-4 flex items-center justify-between" {...fadeIn(active, 0.1, { y: 12 })}>
            <div>
          ...
          <motion.div className="rounded-xl border border-white/[0.06] bg-white/[0.02] px-6 py-3.5 flex items-center justify-between" {...fadeIn(active, 0.25, { y: 12 })}>
          ...
          <motion.div className="rounded-xl border border-white/[0.06] bg-white/[0.02] overflow-hidden mt-1" {...fadeIn(active, 0.35, { y: 12 })}>
        ...
        <motion.p className="text-[8px] text-slate-600 mt-2" {...fadeIn(active, 0.45)}>* Pricing valid for 60 days from date of issue.</motion.p>
      </div>
    </div>
  );
}
